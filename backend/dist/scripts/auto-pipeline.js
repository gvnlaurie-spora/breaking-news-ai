...
async function runPipeline() {
    ...
    if (!isDryRun) {
        try {
            ...
            const scripts = await prisma_1.prisma.script.count({ where: { status: "completed" } });
